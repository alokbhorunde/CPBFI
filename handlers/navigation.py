...
def register(bot):
    ...
    def handle_navhelp(call):
        ...
        # ==================================================
        # STUDENT NAVIGATION - How to Use Platform
        # ==================================================
        ...
        # --------------------------------------------------
            ...
            markup = types.InlineKeyboardMarkup(row_width=1)
            markup.add(
                types.InlineKeyboardButton("⬅️ Back", callback_data="nav_student")
            )

            bot.send_message(cid,
                "🔐 **How to Login**\n\n"
                "1️⃣ Open the student portal\n"
                "2️⃣ Enter your Student ID and Password\n"
                "3️⃣ Click on Login\n"
                "4️⃣ You will land on the Dashboard\n\n"
                "✅ You're logged in!",
                parse_mode="Markdown",
                reply_markup=markup
            )
        ...
        # --------------------------------------------------
        # 2️⃣ HOW TO ACCESS PCQ ASSESSMENT
        # --------------------------------------------------
            ...
            bot.send_message(cid,
                "🧠 **How to Attempt PCQ**\n\n"
                "1️⃣ Login to the student portal\n"
                "2️⃣ You will land on the Dashboard\n"
                "3️⃣ Scroll down on the dashboard\n"
                "4️⃣ Look for the Session cards\n"
                "5️⃣ Click on your Mobilization Session\n"
                "6️⃣ Inside the session, click on PCQ\n"
                "7️⃣ Click on Begin PCQ\n"
                "8️⃣ Answer all questions\n"
                "9️⃣ Click Submit\n"
                "🔟 Your PCQ score will be displayed\n\n"
        ...
        # --------------------------------------------------
        # 3️⃣ HOW TO ACCESS POST ASSESSMENT
        # --------------------------------------------------
            ...
            bot.send_message(cid,
                ...
                "1️⃣ Login to the portal\n"
                "2️⃣ Go to Dashboard\n"
                "3️⃣ Scroll and open your Mobilization Session\n"
                "4️⃣ Click on Post Assessment\n"
                "5️⃣ Click Begin\n"
        ...
        # --------------------------------------------------
        # 4️⃣ HOW TO SUBMIT SESSION FEEDBACK
        # --------------------------------------------------
            ...
            bot.send_message(cid,
                ...
                "1️⃣ Login to the portal\n"
                "2️⃣ Go to Dashboard\n"
                "3️⃣ Scroll to the last session card\n"
                "4️⃣ Click on Feedback\n"
                "5️⃣ Click Begin\n"
                "6️⃣ Fill the feedback form\n"
                "7️⃣ Click Submit\n\n"
        ...
        # --------------------------------------------------
            ...
            bot.send_message(cid,
                ...
                "1️⃣ Login to the portal\n"
                "2️⃣ After login, you will be redirected to Profile\n"
                "3️⃣ Complete Basic Details\n"
                "4️⃣ Click Save & Continue\n"
                "5️⃣ Complete Advanced Details\n"
                "6️⃣ Click Save & Continue\n"
                "7️⃣ Complete Resume Details\n"
                "8️⃣ Click Save\n"
                "9️⃣ You will be redirected to Dashboard\n\n"
        ...
        # --------------------------------------------------
        # 6️⃣ HOW TO DOWNLOAD HR CERTIFICATE
        # --------------------------------------------------
            ...
            bot.send_message(cid,
                ...
                "2️⃣ Go to Dashboard\n"
                "3️⃣ Scroll down\n"
                "4️⃣ Click on Certificates section\n"
                "5️⃣ Click on HR Certificate\n"
                "6️⃣ Certificate will download automatically\n\n"
        ...
        # --------------------------------------------------
        # 7️⃣ HOW TO DOWNLOAD COMPLETION CERTIFICATE
        # --------------------------------------------------
            ...
            bot.send_message(cid,
                ...
                "3️⃣ Scroll down\n"
                "4️⃣ Click on Certificates section\n"
                "5️⃣ Click on Completion Certificate\n"
                "6️⃣ Certificate will download automatically\n\n"
